                        ...
                        <section>
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://www.tanahgajahubud.com/uploads/2019/11/8feb3bc079cc2dec730b6cf665a629d4_47a658527c7b0708a064226a1d2dc150.jpg" alt="" class="w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
                                    ...
                                    <div class="flex space-x-4 mb-5 text-sm font-medium">
                                        <div class="flex-auto flex space-x-4">
                                            <a href=""><button class="h-10 px-6 font-semibold rounded-full bg-violet-600 text-white" type="submit">
                                                    Book Now
                                                </button></a>
                                        ...
                                        <button class="flex-none flex items-center justify-center w-9 h-9 rounded-full text-violet-600 bg-violet-50" type="button" aria-label="Like">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="blue" viewBox="0 0 24 24" stroke-width="1.5" stroke="none" class="w-6 h-6">
                            ...
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://i1.wp.com/helloindonesia.id/wp-content/uploads/2018/12/Tari-Kecak-Ulu-Watu_edited.jpg" alt="" class="w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
                                    <div class="flex flex-wrap">
                                        <h1 class="flex-auto font-medium text-slate-900">
                                    ...
                                    <div class="flex items-baseline mt-4 mb-6 pb-6 border-b borderslate-200">
                                        First, two of the mostvisited tourist attractions in Bali is Ubud, visited by either
                                        local or international tourists.
                                        Ubud Bali tourist attraction has astonished many visitors who alway
                                        s want to return
                                    </div>
                            ...
                            <div class=" font-sans pt-8 text-center">
                                <a href="#" class="inline-flex items-center py-2 px-4 text-sm fontmedium text-gray-500 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                    Previous
                                </a>
                                <!-- Next Button -->
                                <a href="#" class="inline-flex items-center py-2 px-4 ml-3 text-sm fontmedium text-gray-500 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                    Next
                                </a>
                            </div>
                        </section>
...
<?php endif; ?><?php /**PATH D:\kecak\resources\views/layouts/frontpage/landingpage.blade.php ENDPATH**/ ?>